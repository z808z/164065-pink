var link = document.querySelector(".main-nav__toogle");
var menu = document.querySelector(".main-nav__menu");
var mainLogo = document.querySelector(".main-nav__logo");
var hamburger = document.querySelector(".main-nav__toogle");
...
if (link) {
  ...
  hamburger.classList.remove("main-nav__toogle--without-js");
  link.addEventListener("click", function(event) {
    event.preventDefault();
    menu.classList.toggle("main-nav__menu--show");
    link.classList.toggle("main-nav__toogle--close");
  });
}
